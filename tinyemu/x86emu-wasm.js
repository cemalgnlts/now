...
const moduleOverrides = undefined;
...
function getFuncWrapper(func, sig) {
    ...
    const sigCache = funcWrappers[sig];
    if (!sigCache[func]) {
        if (sig.length === 1) {
...
function cwrap(ident, returnType, _argTypes, opts) {
    const argTypes = _argTypes || [];
...
function setValue(ptr, value, _type, noSafe) {
    let type = _type || "i8";
...
function _console_get_size(pw, ph) {
    let r = Module.termSize;
    HEAPU32[pw >> 2] = r[0];
    HEAPU32[ph >> 2] = r[1];
}

// This function write everything in console
// But we also need only stdout.
function _console_write(opaque, buf, len) {
	const chars = HEAPU8.subarray(buf, buf + len);
    const str = String.fromCharCode.apply(String, chars);
	
	eventTarget.dispatchEvent(new CustomEvent("data", {
		detail: str
	}));

	if(Module.stdin.length > 0) {
		Module.stdin.pop();
		return;
	}

	if(str !== "\r\n") {
		eventTarget.dispatchEvent(new CustomEvent("stdout", {
			detail: str
		}));
	}
}
...
function _fs_export_file(filename, buf, buf_len) {
    const _filename = Pointer_stringify(filename);
    const data = HEAPU8.subarray(buf, buf + buf_len);
...
function _fs_wget_update_downloading(flag) {
	...
	eventTarget.dispatchEvent(new CustomEvent("updateDownloading", {
		detail: Boolean(flag)
	}));
}
...
function _tzset() {
    ...
    const winterNamePtr = allocate(
        intArrayFromString(winterName),
        "i8",
        ALLOC_NORMAL
    );
	const summerNamePtr = allocate(
...
const ___emscripten_environ_constructor = (Module[
    "___emscripten_environ_constructor"
] = function () {
...
const __get_daylight = (Module["__get_daylight"] = function () {
    return Module["asm"]["__get_daylight"].apply(null, arguments);
});

const __get_timezone = (Module["__get_timezone"] = function () {
    return Module["asm"]["__get_timezone"].apply(null, arguments);
});

const __get_tzname = (Module["__get_tzname"] = function () {
    return Module["asm"]["__get_tzname"].apply(null, arguments);
});

const _console_queue_char = (Module["_console_queue_char"] = function () {
	Module.stdin.push(arguments[0]);
    return Module["asm"]["_console_queue_char"].apply(null, arguments);
});

const _console_resize_event = (Module["_console_resize_event"] = function () {
    return Module["asm"]["_console_resize_event"].apply(null, arguments);
});

const _display_key_event = (Module["_display_key_event"] = function () {
    return Module["asm"]["_display_key_event"].apply(null, arguments);
});

const _display_mouse_event = (Module["_display_mouse_event"] = function () {
    return Module["asm"]["_display_mouse_event"].apply(null, arguments);
});

const _display_wheel_event = (Module["_display_wheel_event"] = function () {
...
const _fs_import_file = (Module["_fs_import_file"] = function () {
...
const _net_set_carrier = (Module["_net_set_carrier"] = function () {
    return Module["asm"]["_net_set_carrier"].apply(null, arguments);
});

const _net_write_packet = (Module["_net_write_packet"] = function () {
    return Module["asm"]["_net_write_packet"].apply(null, arguments);
});

const _vm_start = (Module["_vm_start"] = function () {
...
const dynCall_iiiiii = (Module["dynCall_iiiiii"] = function () {
    return Module["asm"]["dynCall_iiiiii"].apply(null, arguments);
});

const dynCall_iiiiiii = (Module["dynCall_iiiiiii"] = function () {
    return Module["asm"]["dynCall_iiiiiii"].apply(null, arguments);
});

const dynCall_iiiiiiii = (Module["dynCall_iiiiiiii"] = function () {
    return Module["asm"]["dynCall_iiiiiiii"].apply(null, arguments);
});

const dynCall_iiiiiiiii = (Module["dynCall_iiiiiiiii"] = function () {
    return Module["asm"]["dynCall_iiiiiiiii"].apply(null, arguments);
});

const dynCall_iiiiiiijjjjj = (Module["dynCall_iiiiiiijjjjj"] = function () {
    return Module["asm"]["dynCall_iiiiiiijjjjj"].apply(null, arguments);
});

const dynCall_iiijii = (Module["dynCall_iiijii"] = function () {
    return Module["asm"]["dynCall_iiijii"].apply(null, arguments);
});

const dynCall_iijiiii = (Module["dynCall_iijiiii"] = function () {
    return Module["asm"]["dynCall_iijiiii"].apply(null, arguments);
});

const dynCall_ji = (Module["dynCall_ji"] = function () {
...
const dynCall_viiji = (Module["dynCall_viiji"] = function () {
...
function run(_args) {
    const args = _args || Module["arguments"];
